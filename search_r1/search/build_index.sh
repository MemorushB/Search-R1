...
corpus_file=data/echr_corpus_sliding_window/echr_corpus_split_1024_0.5.jsonl
# corpus_file=data/echr_corpus_split.jsonl
save_dir=data/echr_corpus_sliding_window/1024_0.5/sbert # directory to save the index
retriever_name=sbert # this is for indexing naming
...
# pooling method: cls for BGE, mean for E5 and sbert
